...
//
// If [enablePerf] is false, all calls to [SlogLogger.Elapsed] will be a no-op,
// otherewise, the elapsed statistics will be periodically printed to the console
// in DEBUG-level messages.
